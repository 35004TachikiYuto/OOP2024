...
namespace Test02 {
    ...
    class Program {
        ...
        private static void Exercise03(List<int> numbers) {
            foreach (var order in numbers.OrderByDescending(x => x).Where(x => x % 2 == 1)) {
                Console.Write(order + " ");
            }
        ...
        private static void Exercise04(List<int> numbers) {
            var nums = numbers.Where(x => x >= 10 && x <= 50).ToArray();
        ...
        private static void Exercise05(List<Person> persons) {
            ...
            Console.WriteLine(averageAge+"才");
        ...
        private static void Exercise06(List<Person> persons) {
            ...
            var averageWeight = height.Average(x => x.Weight);
        ...
        private static void Exercise08(List<Person> persons) {
            var yama = persons.Where(x=>x.Name.Contains("山"));
            foreach (var Human in yama) {
