...
namespace Section03 {
    public partial class bt16_6 : Form {
        public bt16_6() {
            InitializeComponent();
        }
        ...
        //非同期メソッド
        private async void bt16_7_Click(object sender, EventArgs e) {
            toolStripStatusLabel1.Text = "";
        ...
        private async void bt16_8_Click(object sender, EventArgs e) {
            toolStripStatusLabel1.Text = "";
        ...
        private async void bt16_9_Click(object sender, EventArgs e) {
            toolStripStatusLabel1.Text = "";
